...
class DatabaseConnection:
    ...
    def file(self):
        ...
        self.len = os.path.getsize("D:\AdvanceCollegeManagementSystem\Frontend\database_data.txt")
        if self.len > 0:
            f = open("D:\AdvanceCollegeManagementSystem\Frontend\database_data.txt", "rb")
    ...
    def d_connection(self, host, port, username, password):
        ...
        self.connection = mysql.connector.connect(host="localhost", port="3306", user="root", password="123@abc")
