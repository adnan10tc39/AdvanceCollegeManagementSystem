...
class AdminDashboard:
    ...
    def __init__(self, window):
        ...
        self.window.iconbitmap('Frontend\\images\\logo.ico')
        self.window.resizable(False, False)
        self.admin_dashboard_frame = ImageTk.PhotoImage \
            (file='Frontend\\images\\admin_frame.png')
        ...
        # ============================Date and time==============================
        # ========================================================================
        self.clock_image = ImageTk.PhotoImage(file="Frontend/images/time.png")
        ...
        # ============================Current user================================
        # ========================================================================
        self.current_user_image = ImageTk.PhotoImage(file="Frontend/images/current_user.png")
        ...
        self.manage = ImageTk.PhotoImage \
            (file='Frontend\\images\\manage.png')
        ...
        self.setting = ImageTk.PhotoImage \
            (file='Frontend\\images\\setting.png')
        ...
        self.exit = ImageTk.PhotoImage \
            (file='Frontend\\images\\exit_button.png')
        ...
        self.logout = ImageTk.PhotoImage \
            (file='Frontend\\images\\logout.png')
    ...
    def click_home(self):
        ...
        self.home_dashboard_frame = ImageTk.PhotoImage \
            (file='Frontend\\images\\home_fram1.png')
    ...
    def click_manage(self):
        ...
        self.manage_dashboard_frame = ImageTk.PhotoImage \
            (file='Frontend\\images\\manage_frame.png')
        ...
        self.student = ImageTk.PhotoImage \
            (file='Frontend\\images\\student.png')
        ...
        self.employee = ImageTk.PhotoImage \
            (file='Frontend\\images\\employee.png')
        ...
        self.department = ImageTk.PhotoImage \
            (file='Frontend\\images\\department.png')
        ...
        self.course = ImageTk.PhotoImage \
            (file='Frontend\\images\\course.png')
        ...
        self.section = ImageTk.PhotoImage \
            (file='Frontend\\images\\section.png')
        ...
        self.batch = ImageTk.PhotoImage \
            (file='Frontend\\images\\batch.png')
    ...
    def click_view(self):
        ...
        self.view_dashboard_frame = ImageTk.PhotoImage \
            (file='Frontend\\images\\view_frame.png')
    ...
    def click_setting(self):
        ...
        self.setting_dashboard_frame = ImageTk.PhotoImage \
            (file='Frontend\\images\\setting_frame.png')
        ...
        self.submit = ImageTk.PhotoImage \
            (file='Frontend\\images\\submit.png')
