...
def win():
    ...
    img = ImageTk.PhotoImage(Image.open("Frontend\\images\\login_frame.png"))

    login = ImageTk.PhotoImage(Image.open("Frontend\\images\\login.png"))

    database_img = ImageTk.PhotoImage(Image.open("Frontend\\images\\connect_database.png"))
