import sys
sys.path.append('D:\AdvanceCollegeManagementSystem')
from tkinter import *
...
class Clock:
    ...
    def clock_image(self, h_, min_, sec_):
        ...
        bg = Image.open("Frontend\\images\\clockNew.jpg")
        ...
        clock_img.save(
            "Frontend\\images\\clock_new_image.png")
    ...
    def clock_usable(self):
        ...
        self.show_img = ImageTk.PhotoImage(file="Frontend\\images\\clock_new_image.png")
...
def win():
    window = Tk()
    b_image = ImageTk.PhotoImage(Image.open('Frontend\\images\\background.jpg'))
    l_image = ImageTk.PhotoImage(Image.open("Frontend\\images\\CMSlogo.png"))
    u_image = ImageTk.PhotoImage(Image.open("Frontend\\images\\user.png"))

    username_icon = ImageTk.PhotoImage(Image.open("Frontend\\images\\username_icon.png"))

    password_icon = ImageTk.PhotoImage(Image.open("Frontend\\images\\security.png"))

    login_button = ImageTk.PhotoImage(Image.open("Frontend\\images\\login_100.png"))

    register_button = ImageTk.PhotoImage(Image.open("Frontend\\images\\register.png"))
