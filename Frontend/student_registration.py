...
class RegisterForm:
    ...
    def __init__(self, wind):
        ...
        self.manage_student_frame = ImageTk.PhotoImage \
            (file='Frontend\\images\\student_frame.png')
        ...
        self.logo_img = ImageTk.PhotoImage \
            (file='Frontend\\images\\uni_logo.png')
        ...
        # ========================================
        self.author = ttk.Label(self.info_frame, text="Developed by Adnan Bajwa\nEnrollment No.  "
                                                      "01-249221-008",
                                font=("yu gothic ui", 13, "bold"), background="white")
        ...
        self.clear_img = ImageTk.PhotoImage \
            (file='Frontend\\images\\clear.png')
