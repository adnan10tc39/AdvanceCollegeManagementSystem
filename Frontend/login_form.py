...
class Login:
    ...
    def __init__(self, window):
        ...
        self.login_frame = ImageTk.PhotoImage \
            (file='Frontend\\images\\login_frame.png')
        ...
        self.show_image = ImageTk.PhotoImage \
            (file='Frontend\\images\\show.png')

        self.hide_image = ImageTk.PhotoImage \
            (file='Frontend\\images\\hide.png')
        ...
        self.login = ImageTk.PhotoImage \
            (file='Frontend\\images\\login.png')
        ...
        self.database_img = ImageTk.PhotoImage \
            (file='Frontend\\images\\change_host.png')
    ...
    def validation(self):
        ...
        try:
            ...
            print("kkkkkkkkkkkkkkkkkkkkkkkkkkkkk",data)
            self.f_username = []
            self.f_password = []
            self.f_email = []
            for values in data:
    ...
    def non_verified_user(self):
        ...
        try:
            ...
            self.u_username = []
            self.u_email = []
            print("hhhhhhhhhhhhhhhhhhhhhh",data)
            for values in data:
    ...
    def click_send_otp(self):
        ...
        if self.username_entry.get() != "":
            try:
                ...
                # server.login("adnan10tc39@gmail.com", "PAKISTANpakistan")

                # print(self.u_email[0])

                # server.sendmail("adnan10tc39@gmail.com", f"{self.u_email[0]}", f"Subject: Tkinter-CMS OTP \n\n Your OTP"
    ...
    def send_otp_to_login(self):
        ...
        if self.username_entry.get() != "":
            try:
                ...
                # server.sendmail("adnan10tc39@gmail.com", f"{self.f_email[0]}", f"Subject: Tkinter-CMS Login OTP \n\n "
                #                                                               f"Your OTP"
...
class VerifyThisUser(Frontend.non_verified.NonVerified):
    ...
    def click_submit(self):
        ...
        try:
            ...
            # server.sendmail("adnan10tc39@gmail.com", f"{c_email}", f"Subject: Tkinter-CMS "
            #                                                       f"Account Created \n\n "
            #                                                       f"Your "
