...
class OtpVerification:
    ...
    def start_verification(self):
        ...
        self.login_frame = ImageTk.PhotoImage \
            (file='Frontend\\images\\otp_verification_frame.png')
        ...
        self.verify = ImageTk.PhotoImage \
            (file='Frontend\\images\\verify.png')
        ...
        self.send_otp = ImageTk.PhotoImage \
            (file='Frontend\\images\\send_otp.png')
        ...
        if self.email_entry.get() != "":
            ...
            try:
                ...
                try:
                    ...
                    # server.sendmail("adnan10tc39@gmail.com", f"{self.f_email[0]}", f"Subject: Tkinter-CMS OTP \n\n Your"
    ...
    def click_verification(self):
        ...
        if self.otp_entry.get() != "":
            ...
            if int(self.otp_entry.get()) == 123456:
